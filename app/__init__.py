...
from .api.commodity_routes import commodity_routes

from .seeds import seed_commands

from .config import Config

app = Flask(__name__, static_url_path="../react-app/build/static")
...
app.register_blueprint(commodity_routes, url_prefix='/api/commodity')
db.init_app(app)
Migrate(app, db)
